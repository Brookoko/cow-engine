...
public readonly struct MetalBrdf : IBrdf
{
    private readonly float r;
    private readonly ConductorFresnel fresnel;
    private readonly TrowbridgeReitzDistribution distribution;

    public MetalBrdf(float r, ConductorFresnel fresnel, TrowbridgeReitzDistribution distribution)
    {
        this.r = r;
